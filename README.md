...
If you want to work off of this base to create your own Sorting Visualizer, feel free to fork this project or to just copy-paste code. Also, subscribe to my YouTube channel if you haven't already, and smash the like button on all my videos. Oh, and check out AlgoExpert if you're preparing for coding interviews.
